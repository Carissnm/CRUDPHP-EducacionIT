    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                ...
                <li><a href="formContacto.php" class="nav-link px-3 text-white a-menu">Contacto</a></li>
            </ul>
            ...
            <div class="text-end">
                ...
                ?>
                <a type="button" href="formLogin.php" class="btn btn-outline-light me-2">Login</a>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton2">
                        ...
                        <li>
                            <a class="dropdown-item" href="formModificarUsuario.php?idUsuario=<?= $_SESSION['idUsuario'] ?>">
